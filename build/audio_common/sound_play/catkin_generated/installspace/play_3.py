...
def classes_callback(msg):
    ...
    if f == 1:
        ...
        if img_flag>=5:
            ...
            print ("g1,g2,g3,g43 = ",g1,g2,g3,g4)
...
def img_callback(data):
    ...
    if f==1 :
        ...
        if img_flag == 3:
            ...
            goal_pose = PoseStamped()
            goal_pose.header.frame_id = "map"
            goal_pose.pose.position.x = 0.304125967026
            goal_pose.pose.position.y = 2.67
            goal_pose.pose.position.z = 0.0
            goal_pose.pose.orientation.x = 0
            goal_pose.pose.orientation.y = 0
            goal_pose.pose.orientation.z = 0.726141160037
            goal_pose.pose.orientation.w =  0.687545646266
            goal_pub.publish(goal_pose) 
    elif f==6:
        if img_flag == 4:
            rospy.sleep(1.5)
