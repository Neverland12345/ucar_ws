...
int main(int argc, char *argv[])
{
	...
	while(ros::ok())
	{
		...
		if(pubCommand)
		{
        	...
        	goal_pose.pose.position.x = 2.30433130264;
        	goal_pose.pose.position.y = -2.61048936844;
        	goal_pose.pose.position.z = 0.0;
        	goal_pose.pose.orientation.x = 0;
        	goal_pose.pose.orientation.y = 0;
        	goal_pose.pose.orientation.z = 0.999943737871;
        	goal_pose.pose.orientation.w = -0.0106075959795;
