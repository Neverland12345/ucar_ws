...
def launch_pkg():
    ...
    nav_cmd = [
        ...
        'sleep 5; roslaunch sound_play soundplay_node.launch',
        'sleep 5; roslaunch xf_mic_asr_offline xf_mic_asr_offline.launch ',
        'sleep 30; roslaunch darknet_ros darknet_ros.launch'
    ]
