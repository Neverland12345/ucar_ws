...
class path_following:
    ...
    def cmd_vel_callback(self,data):
        ...
        data.angular.z =data.angular.z *1.3  #1.6
        ...
        #     self.cmd_data.linear.y = data.linear.y*0.5  
        #     self.cmd_data.angular.z = data.angular.z*1.0  
        # elif self.flag == 3:  #u型弯，减速！！！
        #     self.cmd_data.linear.x = data.linear.x*0.8  
        #     self.cmd_data.linear.y = data.linear.y*1.1
        #     self.cmd_data.angular.z = data.angular.z*1.6  
        # elif self.flag == 4:   #u型弯之前的小直道，加速！
        #     self.cmd_data.linear.x = data.linear.x*1.2 
        #     self.cmd_data.linear.y = data.linear.y*1.0
        #     self.cmd_data.angular.z = data.angular.z*1.2
        # elif self.flag == 5:   #大弯
        #     self.cmd_data.linear.x = data.linear.x*1.0  
        ...
        # elif self.flag == 8:
        #     self.cmd_data.linear.x = data.linear.x*0.8
        #     self.cmd_data.linear.y = data.linear.y*0.8
        #     self.cmd_data.angular.z = data.angular.z*1.0
        # elif self.flag == 10:
        #     self.cmd_data.linear.x = data.linear.x 
        #     self.cmd_data.linear.y = data.linear.y
        ...
        #     self.cmd_data.linear.x = data.linear.x *1.4
        #     self.cmd_data.linear.y = data.linear.y *1.2
        #     self.cmd_data.angular.z = data.angular.z *0.5
    ...
    def path_callback(self,data):
        ...
        if self.front_flag == 0:
            ...
            if len(data.poses)<=47:
                self.flag = 9
            elif len(data.poses)<=90:
                self.flag = 1
            elif len(data.poses)<=115:
                self.flag = 2
            ...
            if len(data.poses) >=83:
                self.flag = 7
            elif len(data.poses)>5 and len(data.poses)<83:
                self.flag = 8
