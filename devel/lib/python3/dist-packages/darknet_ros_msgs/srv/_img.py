...
class imgResponse(genpy.Message):
  _md5sum = "a13e6e0b66542b89487e32a4f77acf85"
...
int16 short_hair_cut_num"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_6h().pack(_x.gh.glass_num, _x.gh.long_hair_num, _x.gh.glass_cut_num, _x.gh.long_hair_cut_num, _x.gh.short_hair_num, _x.gh.short_hair_cut_num))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gh.glass_num, _x.gh.long_hair_num, _x.gh.glass_cut_num, _x.gh.long_hair_cut_num, _x.gh.short_hair_num, _x.gh.short_hair_cut_num,) = _get_struct_6h().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class img(object):
  ...
  _md5sum = '359be61846392affdfa43a82630b4f76'
