...
class imgResponse(genpy.Message):
  _md5sum = "3b3d2b25c18f07e6d5050302bd9d5d58"
...
int16 long_hair_cut_num"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4h().pack(_x.gh.glass_num, _x.gh.long_hair_num, _x.gh.glass_cut_num, _x.gh.long_hair_cut_num))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.gh.glass_num, _x.gh.long_hair_num, _x.gh.glass_cut_num, _x.gh.long_hair_cut_num,) = _get_struct_4h().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class img(object):
  ...
  _md5sum = 'cc46e969b0824e89bc25423516cc80f7'
